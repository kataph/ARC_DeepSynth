...
class Type:
    ...
    def __eq__(self, other):
        ...
        b2 = b2 or (isinstance(self,Tuple) and isinstance(other,Tuple) and self.type_elt.__eq__(other.type_elt))
        b2 = b2 or (isinstance(self,FrozenSet) and isinstance(other,FrozenSet) and self.type_elt.__eq__(other.type_elt))
        b2 = b2 or (isinstance(self,Union) and isinstance(other,Union) and self.type_left.__eq__(other.type_left) and self.type_right.__eq__(other.type_right))
        b2 = b2 or (isinstance(self,Couple) and isinstance(other,Couple) and self.type_left.__eq__(other.type_left) and self.type_right.__eq__(other.type_right))
...
class Union(Type):
    ...
    def __repr__(self):
        if isinstance(self.type_left,Arrow) or isinstance(self.type_right,Arrow):
            ...
            if self == NUMERICAL: return "NUMERICAL"
...
NUMERICAL = Union(INT, INTEGER_TUPLE)
